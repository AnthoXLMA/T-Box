...
function TipPage() {
  ...
  try {
    ...
    const API_URL = "https://us-central1-tipbox-a4f99.cloudfunctions.net/apiV2";
...
{/*        <div className="flex justify-center">
          <div className="p-4 bg-gray-50 rounded-xl shadow-inner">
            <QRCode
              value={`${window.location.origin}/tip-qr?service=${service}&uid=${uid}`}
              size={160}
            />
          </div>
        </div>*/}
...
{/*        <div className="flex justify-center">
          <div className="p-4 bg-gray-50 rounded-xl shadow-inner">
            <QRCode
              value={`https://apiv2-xihdunktcq-uc.a.run.app/tip-qr?service=${service}&uid=${uid}&amount=${amount}&message=${encodeURIComponent(message)}`}
              size={160}
            />
          </div>
        </div>*/}
